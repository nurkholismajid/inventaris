...
$kueri = mysql_query("SELECT * FROM kib_f WHERE id = '$_GET[id]'");
...
<html lang="en">
  ...
  <!-- Navbar
    ...
    <div class="container">	  
			  <h2>Edit KIB F</h2>
			  <form action="proses_edit_kibf.php" method="post">
				...
				<table>
					...
					<tr>
						<td>Luas</td>
						<td><input type="text" class="span3" name="luas" placeholder="Luas Lantai" value="<?echo $row['luas'];?>"></td>
					</tr>	
					<tr>
						<td>Lokasi</td>
						<td><textarea row="3" class="span3" name="lokasi" placeholder="Lokasi"><?echo $row['lokasi'];?></textarea></td>
					</tr>
					<tr>
						<td>Nomor Dokumen</td>
					...
					<tr>
						...
						<td><input type="text" class="span3" name="asal_pembiayaan" placeholder="Asal Pembiayaan" value="<?echo $row['asal_pembiayaan'];?>"></td>
					</tr>
					<tr>
						<td>Nilai Kontrak</td>
						<td><input type="text" class="span3" name="nilai_kontrak" placeholder="Nilai Kontrak" value="<?echo $row['nilai_kontrak'];?>"></td>
					</tr>
					<tr>
						<td>Keterangan</td>
