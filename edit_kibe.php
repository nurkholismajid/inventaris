...
$kueri = mysql_query("SELECT * FROM kib_e WHERE id = '$_GET[id]'");
...
<html lang="en">
  ...
  <!-- Navbar
    ...
    <div class="container">	  
			  <h2>Edit KIB E</h2>
			  <form action="proses_edit_kibe.php" method="post">
				...
				<table>
					...
					<tr>
						<td>Buku</td>
						<td><input type="text" class="span3" name="buku" placeholder="Buku/Perpustakaan" value="<?echo $row['buku'];?>"></td>
					</tr>
					<tr>
						<td>Spesifikasi</td>
						<td><input type="text" class="span3" name="spesifikasi" placeholder="Spesifikasi Asli" value="<?echo $row['spesifikasi'];?>"></td>
					</tr>
					<tr>
						<td>Asal Daerah</td>
						<td><input type="text" class="span3" name="asal_daerah" placeholder="Asal Daerah" value="<?echo $row['asal_daerah'];?>"></td>
					</tr>
					<tr>
						<td>Pencipta</td>
						<td><input type="text" class="span3" name="pencipta" placeholder="Pencipta" value="<?echo $row['pencipta'];?>"></td>
					</tr>
					<tr>
						<td>Jenis</td>
						<td><input type="text" class="span3" name="jenis" placeholder="Jenis" value="<?echo $row['jenis'];?>"></td>
					</tr>
					<tr>
						<td>Ukuran</td>
					...
					<tr>
						<td>Jumlah</td>
						<td><input type="text" class="span3" name="jumlah" placeholder="Jumlah" value="<?echo $row['jumlah'];?>"></td>
					</tr>
					<tr>
						<td>Asal-Usul</td>
