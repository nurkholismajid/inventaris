...
$kueri = mysql_query("SELECT * FROM kib_d WHERE id = '$_GET[id]'");
...
<html lang="en">
  ...
  <!-- Navbar
    ...
    <div class="container">	  
			  <h2>Edit KIB D</h2>
			  <form action="proses_edit_kibd.php" method="post">
				...
				<table>
					...
					<tr>
						<td>Konstruksi</td>
						<td><input type="text" class="span3" name="konstruksi" placeholder="Konstruksi" value="<?echo $row['konstruksi'];?>"></td>
					</tr>
					<tr>
						<td>Panjang</td>
						<td><input type="text" class="span3" name="panjang" placeholder="Panjang (km)" value="<?echo $row['panjang'];?>"></td>
					</tr>
					<tr>
						<td>Lebar</td>
						<td><input type="text" class="span3" name="lebar" placeholder="Lebar (m)" value="<?echo $row['lebar'];?>"></td>
					</tr>
					<tr>
						<td>Luas (m2)</td>
						<td><input type="text" class="span3" name="luas" placeholder="Luas (m2)" value="<?echo $row['luas'];?>"></td>
					</tr>
					<tr>
						<td>Letak/Lokasi</td>
						<td><input type="text" class="span3" name="lokasi" placeholder="Luas (m2)" value="<?echo $row['lokasi'];?>"></td>
					</tr>
					<tr>
