...
$kueri = mysql_query("SELECT * FROM kib_b WHERE id = '$_GET[id]'");
...
<html lang="en">
  ...
  <!-- Navbar
    ...
    <div class="container">	  
			  <h2>Edit KIB B</h2>
			  <form action="proses_edit_kibb.php" method="post">
				...
				<table>
					...
					<tr>
						<td>Bahan</td>
						<td><input type="text" class="span3" name="bahan" placeholder="Bahan" value="<?echo $row['bahan'];?>"></td>
					</tr>
					<tr>
						<td>Lokasi</td>
						<td><input type="text" class="span3" name="lokasi" placeholder="Lokasi" value="<?echo $row['lokasi'];?>"></td>
					</tr>
					<tr>
						<td>Merk</td>
						<td><input type="text" class="span3" name="type" placeholder="Merk" value="<?echo $row['type'];?>"></td>
					</tr>
					<tr>
						<td>Ukuran</td>
						<td><input type="text" class="span3" name="ukuran" placeholder="Ukuran" value="<?echo $row['ukuran'];?>"></td>
					</tr>
					<tr>
						<td>No Pabrik</td>
						<td><input type="text" class="span3" name="no_pabrik" placeholder="No Pabrik" value="<?echo $row['no_pabrik'];?>"></td>
					</tr>
					<tr>
						<td>No Rangka</td>
						<td><input type="text" class="span3" name="no_rangka" placeholder="No Rangka" value="<?echo $row['no_rangka'];?>"></td>
					</tr>
					<tr>
						<td>No Mesin</td>
						<td><input type="text" class="span3" name="no_mesin" placeholder="No Mesin" value="<?echo $row['no_mesin'];?>"></td>
					</tr>
					<tr>
						<td>No Polisi</td>
						<td><input type="text" class="span3" name="no_polisi" placeholder="No Polisi" value="<?echo $row['no_polisi'];?>"></td>
					</tr>
					<tr>
						<td>No BPKB</td>
						<td><input type="text" class="span3" name="no_bpkb" placeholder="No BPKB" value="<?echo $row['no_bpkb'];?>"></td>
					</tr>
					<tr>
						<td>Asal-Usul</td>
